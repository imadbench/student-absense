...
<body>
    ...
    <main class="main-content">
        ...
        <div class="actions-bar">
            <a href="all_justifications.php" class="btn btn-secondary">← Back to All Justifications</a>
        </div>
        ...
        <?php else: ?>
            <div class="form-actions">
                <a href="justification_review.php?id=<?php echo $request_id; ?>" class="btn btn-primary">Review Justification</a>
            </div>
        <?php endif; ?>
    </main>
